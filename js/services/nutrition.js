...
export class NutritionService {
     ...
     */
    scaleByServings(perServing, servings) {
        return {
     ...
     */
    estimateNutrition(meal, recipeName) {
     ...
     */
    getAveragePlate(category, name) {
        const isAbout = (word) => category.includes(word) || name.includes(word);
