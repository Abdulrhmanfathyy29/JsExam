...
export class RecipePage {
    constructor(api, storage, nutritionService, ui, onMealLogged, goBack) {
        this.meal = null;
        this.nutrition = null;
        this.section = document.getElementById('recipe-detail-modal');
        this.api = api;
     ...
     */
    createNutrientBar(label, grams, percent, color) {
